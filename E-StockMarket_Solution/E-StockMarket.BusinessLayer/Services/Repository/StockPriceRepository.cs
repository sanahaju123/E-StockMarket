    ...
    public class StockPriceRepository : IStockPriceRepository
    {
        ...
        public async Task<StockPrice> UpdateStockPrice(RegisterStockPriceViewModel model)
        {
            ...
            try
            {
                ...
                updateStockPriceInfo.StockPriceDate = model.StockPriceDate;
                updateStockPriceInfo.StockPriceTime = model.StockPriceTime;
                updateStockPriceInfo.IsDeleted = model.IsDeleted;
