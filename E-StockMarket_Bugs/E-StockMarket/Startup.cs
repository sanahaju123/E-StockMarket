...
namespace E_StockMarket
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IComponyInfoRepository, ComponyInfoRepository>();
            services.AddScoped<IComponyInfoServices, ComponyInfoServices>();
            services.AddScoped<IStockPriceRepository, StockPriceRepository>();
            services.AddScoped<IStockPriceServices, StockPriceServices>();
        }
